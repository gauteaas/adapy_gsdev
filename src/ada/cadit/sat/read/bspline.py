...
def create_bspline_from_sat(spline_data_str: str) -> BSplineSurfaceWithKnots | RationalBSplineSurfaceWithKnots:
    #copied bspline surface func, rewrite to work for bspline
